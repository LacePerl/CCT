...
<body>
    ...
    <form action="agape/verificalogin.php" method = "POST">
    <div id="tut">
...
<input name = "senhal" type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock" required>
