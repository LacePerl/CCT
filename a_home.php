...
<body>
    ...
    <div class="d-grid gap-2 col-6 mx-auto">
        ...
        <a href="a_loguinho.php"><button class="btn btn-primary" type="button">Entrar</button></a>
       </div>
       <div class="d-flex justify-content-center">
        <a href="a_cadastrarse.php"><button class="btn btn-primary" type="button">Cadastrar-se</button></a>
    </div>
      </div>
</main>
<main>
